...
<?php
if(arg(0)=="search-smithsonian-museum" && count($view->result) == 0 && (!strpos($_SERVER['REQUEST_URI'],"?")))
{
?>
  <?php if ($exposed): ?>
...
{
	$sql = "insert into paging_full_record (unique_url,session_id,timestamp,records,uid,ip_add,page,url) values ('$md_var','$session_id',$timestamp,'$rec',$uid,'$ip','smit','$string')";
