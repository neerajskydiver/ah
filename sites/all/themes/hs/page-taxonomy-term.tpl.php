...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>">
    ...
    <div id="container" class="clear-block">
						    ...
						    <div id="leaderboard"> <?php print $topleft ?> </div>
      <div id="header">
...
-->		  
		  ...
		  <li><a href="#">
		  <img alt="twitter"  src="<?php echo $base_path; ?>sites/all/themes/hs/images/twitter.png"></a></li>
		  <li><a href="<?php echo $base_path."rss.xml"?>">
		  <img alt="feed"  src="<?php echo $base_path; ?>sites/all/themes/hs/images/feed.png"></a></li>
		  </ul>
		  <?php if ($search_box): ?>
      ...
      <?php endif; ?>
						  ...
						  <?php if ($right): ?>
						  <div id="right" class="sidebar" style="float:right;">
						  <?php print $right ?>
						  </div>
...
<div class="left-corner"> <?php print $breadcrumb; ?>
    ...
    <?php if ($title): 
		  if (arg(0) == 'taxonomy') {$term= taxonomy_get_term(arg(2));
						...
						if($checkvid==8){
						?>
    <div id="blogHeader"> <img src="<?php echo $base_path?>sites/default/files/blogs/bully_pulpit/blogHeader.png" alt="bully pulpit header" />
