...
$result_cnt_var .= $start_record_no = (($page_no*$itme_per_page_no)+1 );
...
<div class="<?php print $classes; ?>">
  ...
  <?php endif; ?>
<?php if(arg(0)=="search-navy-museum" && count($view->result) == 0 && (!strpos($_SERVER['REQUEST_URI'],"?")))
{
?>
  <?php if ($exposed): ?>
...
/*
$_SESSION['navy'][$md_var]= $arr;
print_r($_SESSION['navy'][$md_var]);
*/
...
{
	$sql = "insert into paging_full_record (unique_url,session_id,timestamp,records,uid,ip_add,page,url) values ('$md_var','$session_id',$timestamp,'$rec',$uid,'$ip','navy','$string')";
