...
<!--<a href="<?php echo $base_path?>node/19046" title="image">
<img alt="" src="<?php echo $base_path; ?>sites/all/themes/hs/images/heritage_traveler_placeholder.png" /></a>-->
...
<!--<div id="leaderboard"><img alt="" src="<?php echo $base_path; ?>sites/all/themes/hs/images/AmerClass_728x90.gif" /> </div>-->
...
<div id="search">
	<ul>
	<li><a href="http://www.facebook.com/pages/American-Heritage-Publishing/129491773754888?v=info" target="_blank">
	<img alt="facebook"  src="<?php echo $base_path; ?>sites/all/themes/hs/images/facebook.png" /></a>
	</li>
	<li><a href="#"><img alt="twitter"  src="<?php echo $base_path; ?>sites/all/themes/hs/images/twitter.png" /></a>
	</li>
	<li><a href="<?php echo $base_path."rss.xml"?>">
	<img alt="feed"  src="<?php echo $base_path; ?>sites/all/themes/hs/images/feed.png" /></a>
	</li>
	</ul>
  	<?php if ($search_box): ?>
	<div id="search-box"><?php print $search_box ?>
	</div><?php endif; ?>
</div> <!--Search-->
...
<div class="main-cont taxo-list">

			<?php if ($left): ?>
			<div id="sidebar-left" class="sidebar">
			<?php if ($search_box): ?>
			<div class="block block-theme"><?php //print $search_box ?>
			</div><?php endif; ?>
			<?php print $left ?>
			</div> <!--sidebar-left-->
			<?php endif; ?>
...
<div class="left-corner">
						...
						<?php if ($title): 
						if (arg(0) == 'taxonomy') {$term= taxonomy_get_term(arg(2));
						$checkvid=$term->vid;}
						if($checkvid==8){
						?>
		<div id="blogHeader">
 	    <img src="<?php echo $base_path?>sites/default/files/blogs/bully_pulpit/blogHeader.png" alt="bully pulpit header" />
		<p>Presidents In Life and Lore</p>
