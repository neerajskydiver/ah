...
<!--							<a href="http://www.facebook.com/pages/American-Heritage-Publishing/129491773754888?v=info">
-->				
<a href="https://www.facebook.com/AmericanHeritageMagazine" target="_blank">				
					...
					</div>					<h1><span>A</span>merican <span>H</span>eritage</h1>
					<h2>
		<?php if ($logo) {
...
<div class="main-cont" id="wrapper">
		<div id="main" class="historic-sites">
			<div class="heading">
...
<!-- class for liquid layout -->
			...
			<div id="main" class="historic-sites-main">
				<?php endif; ?>
				<div id="squeeze">
