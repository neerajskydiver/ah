...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>">
  ...
  <meta name="SKYPE_TOOLBAR" content="SKYPE_TOOLBAR_PARSER_COMPATIBLE" /> 
    <?php print $head ?>
    <title><?php print $head_title;//print ucwords(strtolower($head_title)); ?></title>
    <?php print $styles ?>
    <?php print $scripts ?>
    <!--[if lt IE 7]>
      ...
      <div class="right-corner">
        ...
        <?php if ($mission): print '<div id="mission">'. $mission .'</div>'; endif; ?>
          ...
          <?php print $help; ?>
            ...
            <div class="article magazine clear-block" id="magazine">
            <?php print  '<h2 class="byline">'.$node->field_deck[0]['view'].'</h2>'; ?>
          ...
          <?php if ($tabs): print '</div>'; endif; ?><!--tabs-wrapper-->
        </div><!--.left-corner, -->
      </div><!--.right-corner,-->
    </div><!--#squeeze,-->
  </div> <!-- // / /#main -->
